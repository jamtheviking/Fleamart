...
public class LandingPage extends AppCompatActivity {
    ...
    EditText username, password, firstName,
            lastName,cell, confirmPassword, email;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scene3.setEnterAction(new Runnable() {
            ...
            public void run() {
                ...
                cell = findViewById(R.id.etCellRegister);
    ...
    public void registerUser() {
        ...
        String cl = cell.getText().toString().trim();
        String em = email.getText().toString().trim();
        String pw = password.getText().toString().trim();
        String cpw = confirmPassword.getText().toString().trim();
        String hashPw;

        EditText[] fields = {firstName, lastName, username,cell, email, password, confirmPassword};
    ...
    private void addUser(String firstName, String lastName, String username,String cell, String email, String hashedPassword) {
        ///Needs Try Catch
        db.insertUser(firstName, lastName, username,cell, email, hashedPassword);
    }
    ...
    public void populateUsers(){
        ...
        db.insertUser("John","Doe","johndoe123","6043251456","johndoe@example.com",password);
        db.insertUser("Jane","Smith","janesmith89","6043251456","janesmith@example.com",password);
        db.insertUser("Michael","Johnson","mikej_123","6043251456","michael.j@example.com",password);
        db.insertUser("Emily","Brown","ebrown2022","6043251456","emily.brown@example.com",password);
        db.insertUser("David","Wilson","davidw88","6043251456","dwilson@example.com",password);
