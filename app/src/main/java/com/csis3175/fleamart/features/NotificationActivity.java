...
public class NotificationActivity extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //Declares database helper on the OnCreate view to be used for this class.
    ...
    /**
     * This method is used to return a populated List of Notifications object to be passed into the recycler view.
     * @return
     */
    private ArrayList<Notifications> getNotifications() {
        ArrayList<Notifications> notificationsList = new ArrayList<>();
        Cursor c = databaseHelper.viewNewNotifications(userId);
        if (c != null && c.moveToFirst()) {
            do {
                ...
                boolean isSeen = c.getInt(c.getColumnIndexOrThrow("isSeen"))==1;
                ...
                notificationsList.add(new Notifications(notificationId, notificationMessage, isSeen, transaction_id, transaction_buyer_id, transaction_seller_id));
            } while (c.moveToNext());
